...
class HappyBoxExperienceController extends Controller
{
    /**
    ...
    public function create(Request $request)
    {
        try{
            ...
            $input = $request->all();
            $h = HappyboxExperience::create($input);
            return response([
                'status' => 0,
    ...
    public function byexperience($id, Request $request){
        try {
            $h =  HappyboxExperience::where('experience', $id)->get();
            return response([
                'status' => 0,
                'message' => 'fetched successfully',
                'data' => $h
    ...
    public function bybox($id, Request $request){
        try {
            $h =  HappyboxExperience::where('happybox', $id)->get();
            return response([
                'status' => 0,
                'message' => 'fetched successfully',
                'data' => $h
