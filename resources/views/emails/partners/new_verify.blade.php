...
<div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;">
	<div style="width:100%;">
		<a href="https://happybox.ke/" target="_blank"> <img src="img/on_boarding_header.png" alt="" style="padding-bottom:15px;width:100%;"></a>
	</div>
	...
	<div style="width:80%; margin:18px auto;" >
		<img src="img/congrats_partnerwelcome.png" alt="" style="width:100%;">
	</div>
	<div style="width:80%;margin:10px auto;text-align:center;" >
		<p> We are happy to welcome you to the HappyBox Partner community; providing you<br>
			with visibility and new customers. </p>
                <p> 
                    To have access to your Partner Portal on <a href="https://happybox.ke/" target="_blank" style="color: black; text-decoration: none;">happybox.ke</a>, please use the link "Activate<br> 
your account", then input the user name (email address) and the password below.
...
Password: xxxxxxxxx
	...
	<div style="width:80%;margin:10px auto;" >
		<table align='center' style="text-align:center;">
			<tr>
				<td style="width:50%;padding-top:30px;vertical-align:top;"><img src="img/icn-functions-03-teal.png" alt="" style="margin:5px auto;">
				...
				<td style="padding-top:30px;vertical-align:top;"><img src="img/icn-functions-02-orange.png" alt="" style="margin:5px auto;">
					<p style="color:#FA683D;"> Keep track of the vouchers redeemed <br>
						in your business, and payments made<br>
						to you. </p></td>
			</tr>
			<tr>
				<td style="padding-top:30px;vertical-align:top;"><img src="img/icn-functions-01-blue.png" alt="" style="margin:5px auto;">
					<p style="color:#0185B6;"> Monitor the services you have<br>
						allocated to each box. </p></td>
				<td style="padding-top:30px;vertical-align:top;"><a href="#" target="_blank"> <img src="img/btn-user-activate.png" alt="" style="margin:5px auto;"> </a></td>
			</tr>
		</table>
	</div>
	<div style="width:80%;margin:10px auto;" class="mob_100">
		<div style="">
			<a href="https://happybox.ke/" target="_blank"><img src="img/need_help.png" style=" margin:0px auto;padding-top:30px;" alt=""></a>
		</div>
	</div>
	<div style="width:80%;margin:10px auto;" class="mob_100">
	...
	<div style="width:80%;margin:10px auto;" >
		<table align="center"  style="width:100%;">
			<tr>
				<td style="width:50%;padding-top:2px;vertical-align:top;" align="center"><img src="img/icn-mail-blue.png" alt="" style="margin:5px auto;">
					<p > <b>
   <a style="color:#0185B6;text-decoration:none;" href="mailto:director@happybox.ke">director@happybox.ke</a></b> </p></td>
				<td style="padding-top:2px;vertical-align:top;" align="center"><img src="img/icn-phone-blue.png" alt="" style="margin:5px auto;">
					<p > <b>
	...
	<div style="width:80%; margin:50px auto 14px;">
		<img src="img/onboarding_your.png" alt="" style="margin:33px auto 4px;">
	</div>
	<div style="width:100%">
		<div style="">
			<a href="https://happybox.ke/" target="_blank"> <img src="img/news_see_you_soon.png" style=" margin:0px auto;padding-top:29px;width:80%;" alt=""></a>
		</div>
	</div>
	<div style="width:100%">
		<div style="">
...
margin:-1px auto;" class="mob_95">
		<div style="width:50%;float:left">
			<img src="img/hb-alt-logo-white.png" style=" display:inline;" alt=""> <img src="img/Chooseyourgift.png" style=" display:inline;" alt="">
		</div>
		<div style="width:50%;float:left;text-align:right;">
			<a href="https://www.facebook.com/HappyBoxke-104873668046223" target="_blank"><img src="img/icn-fb-white.png" style=" display:inline;height:26px;margin-left:19px;" alt=""></a> <a href="https://www.instagram.com/happybox.ke/" target="_blank"><img src="img/icn-ig-white.png" style="display:inline;height:26px;margin-left:19px;" alt=""></a> <a href="https://www.linkedin.com/company/happybox-ke/" target="_blank"><img src="img/icn-li-white.png" style="display:inline;height:26px;margin-left:19px;" alt=""></a>
		</div>
	</div>
