...
<div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;">
	...
	<div style="width:80%;margin:10px auto;" class="mob_100">
		...
		<img src="{{asset('mails/forgot_password.png')}}" alt="" style="margin:0px auto;">
	</div>
	...
	<div style="width:80%; margin:18px auto;text-align: center;" >
		<a href="{{ $url }}" target="_blank"> <img src="{{asset('mails/btn-password-reset.png')}}" alt="" style=" margin:0px auto;"> </a>
	</div>
...
margin:-2px auto;" class="mob_95">
 ...
 <div style="width:100%;float:left;">
		<div style=" text-align:center;margin-bottom:10px;margin-top:10px;">
			<a href="{{Config::get('app.client_url')}}/user-login.php" style="text-align:center;text-decoration:underline;font:normal normal normal 14px/20px Calibri;letter-spacing:0px;color:#999999;" target="_blank">Login to your Account </a></div>
	</div>
