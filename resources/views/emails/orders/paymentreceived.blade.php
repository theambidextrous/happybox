    ...
    <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <h1 class="size-34" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #C20A2B;font-size: 30px;line-height: 38px;font-family: Open Sans,sans-serif;text-align: center;" lang="x-size-34">
                <strong>Payment Acknowledgement</strong>
            </h1>
            <h3 style="Margin-top: 20px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #d1e9dc;font-size: 14px;line-height: 21px;font-family: Open Sans,sans-serif;text-align: center;">
                <strong>— happybox customer care —</strong>
            </h3>
            <p class="size-15" style="Margin-top: 12px;Margin-bottom: 20px;font-size: 15px;line-height: 23px;" lang="x-size-15">
                Dear Customer, 
                <span>We acknowledge receiption of a new order you placed via our website www.happybox.ke. In addition, we also acknowledge receiving payment as follows:-</span>
            </p>
        </div>
    </div>
        ...
        <div class="column" style="text-align: left;color: #697d71;font-size: 14px;line-height: 21px;font-family: Merriweather,Georgia,serif;">
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                    ...
                    Order Number: <b>{{ $order->order_id }}</b><br>
                    Order Amount: <b>KES {{ number_format(floor($order->order_totals), 2) }}</b><br>
                    Paid Amount: <b>KES {{ number_format(floor($order->paid_amount), 2) }}</b><br>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
                ...
                <!--[if !mso]-->
                    ...
                    <br><br>
                    <p class="size-22" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 18px;line-height: 26px;text-align: center;" lang="x-size-22">You will receiver order summary in a short time. Thank you for transacting with us.<br><br><br>Best Wishes!<br>Happy Box Team</p>
                <!--[endif]-->
                </div>
            </div>
            <div style="Margin-left: 20px;Margin-right: 20px;">
