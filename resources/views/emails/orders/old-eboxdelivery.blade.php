<html style="margin: 0px; padding: 0px; height: 100%;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]--><head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>HappyBox Mails Service</title>
...
body{background-color:#ddf0e6}.logo a:hover,.logo a:focus{color:#1e2e3b !important}.mso .layout-has-border{border-top:1px solid #96d1b2;border-bottom:1px solid #96d1b2}.mso .layout-has-bottom-border{border-bottom:1px solid #96d1b2}.mso .border,.ie .border{background-color:#96d1b2}.mso h1,.ie h1{}.mso h1,.ie h1{font-size:26px !important;line-height:34px !important}.mso h2,.ie h2{}.mso h3,.ie h3{}.mso .layout__inner,.ie .layout__inner{}.mso .footer__share-button p{}.mso .footer__share-button p{font-family:PT Sans,Trebuchet MS,sans-serif}
...
<![endif]-->
<!--[if !mso]><!-->
  <body class="half-padding" style="margin: 0px; padding: 0px; text-size-adjust: 100%; height: 340px; overflow-y: auto;">
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #ddf0e6;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      <div role="banner">
        <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 167440px);">
          <div style="border-collapse: collapse;display: table;width: 100%;">
          <!--[if (mso)|(IE)]><table align="center" class="preheader" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 280px" valign="top"><![endif]-->
            <div class="snippet" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #C20A2B;font-family: PT Sans,Trebuchet MS,sans-serif;">
              
            </div>
          <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
            <div class="webversion" style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #C20A2B;font-family: PT Sans,Trebuchet MS,sans-serif;">
    ...
    <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <h1 class="size-34" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #C20A2B;font-size: 30px;line-height: 38px;font-family: Open Sans,sans-serif;text-align: center;" lang="x-size-34">
                <strong>A HappyBox for you</strong>
            </h1>
            ...
            <p class="size-15" style="Margin-top: 12px;Margin-bottom: 20px;font-size: 15px;line-height: 23px;" lang="x-size-15">
                Hi there, 
                <span>Someone surprised you with a happybox. Checkout the following information</span>
            </p>
        </div>
    </div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                    <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #C20A2B;font-size: 22px;line-height: 31px;font-family: Open Sans,sans-serif;text-align: center;">
                        <strong>Your HappyBox Details&nbsp;</strong>
                    </h1>
                    ...
                    <tbody>
                    <tr>
                      <td>HappyBox Name ({{$payload['type']}})</td>
                      <td>{{$payload['box']}}</td>
                    </tr>
                    <tr>
                      <td>HappyBox Image</td>
                      <td><img src="{{$payload['image']}}" alt="{{$payload['box']}}" width="100px"/></td>
                    </tr>
                    <tr>
                      <td>HappyBox EBook</td>
                      <td><a download target="_blank" href="{{$payload['ebook']}}" title="{{$payload['box']}}"></a></td>
                    </tr>
                    <tr>
                      <td>HappyBox Vouchers ({{$payload['qty']}})</td>
                      <td>
                          @if(count($payload['vouchers']))
                          @foreach( $payload['vouchers'] as $vc )
                            {{$vc['box_voucher']}}<br>
                          @endforeach
                          @endif
                      </td>
                  ...
                  <p class="size-15" style="Margin-top: 12px;Margin-bottom: 20px;font-size: 15px;line-height: 23px;" lang="x-size-15">To enjoy this HappyBox, you need to go to {{config('app.name')}} website, create account and activate the voucher(s).</p>
                </div>
            </div>
            <div style="Margin-left: 20px;Margin-right: 20px;">
                <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                <!--[if !mso]-->
                    <a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #C20A2B;font-family: Merriweather, Georgia, serif;" href="{{Config::get('app.APP_CLIENT_APP_URL')}}" target="_blank">Activate your voucher(s) here</a>

                    <br><br>
                    <p class="size-22" style="Margin-top: 20px;Margin-bottom: 20px;font-size: 18px;line-height: 26px;text-align: center;" lang="x-size-22">Thank you for transacting with us.<br><br><br>Best Wishes!<br>HappyBox Team</p>
                <!--[endif]-->
                </div>
            </div>
            <div style="Margin-left: 20px;Margin-right: 20px;">
...
<script type="text/javascript" src="{{asset('dist/polyfill.min.js?h=0C955C9D20191204125554')}}"></script>

<script type="text/javascript" src="{{asset('dist/tsb.min.js?h=354E27EC20191204125554')}}"></script>

<script type="text/javascript" src="{{asset('dist/emailPreview-iframe.min.js?h=B3949D4520191204125554')}}" data-model="{&quot;Scrollbars&quot;:true}"></script>
