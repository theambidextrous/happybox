    ...
    <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <h1 class="size-34" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #C20A2B;font-size: 30px;line-height: 38px;font-family: Open Sans,sans-serif;text-align: center;" lang="x-size-34">
                <strong>Voucher Cancellation by Partner</strong>
            </h1>
            ...
            <p class="size-15" style="Margin-top: 12px;Margin-bottom: 20px;font-size: 15px;line-height: 23px;" lang="x-size-15">
                Dear HappyBox Admin, <br>
                {{ucwords(strtolower($payload['partner']))}} has cancelled an already redeemed voucher citing the following reason(s):-<br>
                <span>"<i>{{$payload['reason']}}</i>"</span>
            </p>
        </div>
    </div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                    <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #C20A2B;font-size: 22px;line-height: 31px;font-family: Open Sans,sans-serif;text-align: center;">
                        <strong>New Voucher information&nbsp;</strong>
                    </h1>
                    ...
                    Voucher Number: <b>{{ $payload['voucher'] }}</b><br>
                  </p>
                </div>
            </div>
            <div style="Margin-left: 20px;Margin-right: 20px;">
