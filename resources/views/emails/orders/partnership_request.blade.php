    ...
    <div style="Margin-left: 20px;Margin-right: 20px;">
        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
            <h1 class="size-34" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #C20A2B;font-size: 30px;line-height: 38px;font-family: Open Sans,sans-serif;text-align: center;" lang="x-size-34">
                <strong>New Partnership Request</strong>
            </h1>
            ...
            <p class="size-15" style="Margin-top: 12px;Margin-bottom: 20px;font-size: 15px;line-height: 23px;" lang="x-size-15">
                Dear Admin, <br>
                <span>A new partnership request has been received with the following information:</span><br>
                <h2>Busines information</h2>
                <span>Business Name: <b>{{$payload['business_name']}}</b></span><br>
                <span>Business Category: <b>{{$payload['business_category']}}</b></span><br>
                <span>Business Description: <b>{{$payload['short_description']}}</b></span><br>
                <span>Business Registration: <b>{{$payload['business_reg_no']}}</b></span><br>
                <span>Business Location: <b>{{$payload['location']}}</b></span><br>
                
                <h2>Contact person information</h2>
                <span>First Name: <b>{{$payload['fname']}}</b></span><br>
                <span>Sur Name: <b>{{$payload['sname']}}</b></span><br>
                <span>Email Address: <b>{{$payload['email']}}</b></span><br>
                <span>Mobile phone: <b>{{$payload['phone']}}</b></span><br>
            </p>
        </div>
    </div>
