...
<div border="0" cellpadding="0" cellspacing="0" style="max-width:800px;width:100%;margin:0 auto;padding:0;overflow-x:hidden;background:#fff;margin-top:36px;">
    ...
    <span style="background:#c20a2b;height:40px;display:table-cell;width:40px;border-radius:100%;text-align:center;padding-top:0px;color:white;vertical-align:middle;font-weight:bold;font-size:20px;">1</span></td>
					<td style="vertical-align:middle;"><p style="padding-left:7px;"> <span style="color:#C20A2B;"> <strong>ACTIVATE</strong></span> your voucher early on <a href="https://happybox.ke/" target="_blank" style="text-decoration:none;font-weight:bold;"><span style="color:#C20A2B;">happybox.ke</span></a> in the <a href="{{Config::get('app.client_url')}}/user-dash-activate-voucher.php" style="text-decoration:none;font-weight:bold;" target="_blank"><span style="color:#000;">register your voucher </span></a> section </p></td>
				</tr>
				<tr>
					<td colspan="2" style="height:20px"></td>
				</tr>
				<tr>
					<td style="width:12%;"><span style="background:#c20a2b;height:40px;display:table-cell;width:40px;border-radius:100%;text-align:center;padding-top:0px;color:white;vertical-align:middle;font-weight:bold;font-size:20px;">2</span></td>
					<td style="vertical-align:middle;"><p style="padding-left:7px;"> <span style="color:#C20A2B;"> <strong> SELECT</strong></span> your next experience on <a href="https://happybox.ke/" target="_blank" style="text-decoration:none;font-weight:bold;"><span style="color:#C20A2B;">happybox.ke</span></a> </p></td>
				</tr>
				<tr>
					<td colspan="2" style="height:20px"></td>
				</tr>
				<tr>
					<td style="width:12%;vertical-align:middle;">
					 <span style="background:#c20a2b;height:40px;display:table-cell;width:40px;border-radius:100%;text-align:center;padding-top:0px;color:white;vertical-align:middle;font-weight:bold;font-size:20px;">3</span>   
					</td>
					<td style="vertical-align:middle;"><p style="padding-left:7px;"> <strong><a href="https://happybox.ke/" target="_blank" style="text-decoration:none;"><span style="color:#C20A2B;">BOOK</span></a></strong> your experience with the selected partner and share<br>your voucher code, stating you have a HappyBox </p></td>
				</tr>
			</tbody>
		</table>
	</div>
